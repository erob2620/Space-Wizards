...
{
    public class Halliday : Enemy
    {
        public Halliday(int characterLV, Game1 _game, PlayerCharacter pc)
            : base(characterLV, _game)
        {
            image = Content.Load<Texture2D>(@"Images/haliday");
            this.SP_ATK_MOD = 1f;
            this.SP_DEF_MOD = 1f;
            this.SPD_MOD = 1f;
            this.DEF_MOD = 1f;
